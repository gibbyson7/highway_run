...
Public Class Form1
    ...
    Private font As New MCvFont(CvEnum.FONT.CV_FONT_HERSHEY_TRIPLEX, 0.5, 0.5)
    ...
    Public Class EigenObjectRecognizer
        Public _eigenImages As Image(Of Gray, [Single])()
        Public _avgImage As Image(Of Gray, [Single])
        Public _eigenValues As Matrix(Of Single)()
        Public _labels As String()
        Public _eigenDistanceThreshold As Double
        ...
        Public Shared Function GenerateLabels(ByVal size As Integer) As [String]()
...
#End Region
    ...
    Public Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        currentFrame = grabber.QueryFrame().Resize(950, 500, Emgu.CV.CvEnum.INTER.CV_INTER_CUBIC)
        ...
        For Each f As MCvAvgComp In facesDetected(0)
            ...
            BusCar.Location = f.rect.Location
    ...
    Public Sub RoadMover_Tick(sender As Object, e As EventArgs) Handles RoadMover.Tick
        ...
        For x As Integer = 0 To 11
            ...
            '    'draw the face detected in the 0th (gray) channel with blue color
            '    currentFrame.Draw(f.rect, New Bgr(Color.Red), 2)
            '    '                Dim fpos As RectangleF = RectangleF.op_Implicit(MCvAvgComp.rect)
            '    '                BusCar.Location = fpos
        ...
        If BusCar.Bounds.IntersectsWith(EnemyCar4.Bounds()) Then
            gameOver()
        End If
        'BusCar.Draw(name, font, New Point(f.rect.X - 2, f.rect.Y - 2), color:=New Bgr(Color.LightGreen))
    End Sub
    ...
    Public Sub Right_mover_Tick(sender As Object, e As EventArgs) Handles Right_mover.Tick
        If (BusCar.Location.X < 750) Then
            BusCar.Left += 5
        End If
    End Sub

    Public Sub Left_mover_Tick(sender As Object, e As EventArgs) Handles Left_mover.Tick
        If (BusCar.Location.X > 250) Then
            BusCar.Left -= 5
        End If
    End Sub

    Public Sub Main_KeyUp(sender As Object, e As KeyEventArgs) Handles MyBase.KeyUp
        Right_mover.Stop()
        Left_mover.Stop()
    End Sub

    Public Sub Enemy1_Mover_Tick(sender As Object, e As EventArgs) Handles Enemy1_Mover.Tick
        EnemyCar1.Top += 3
    ...
    Private Sub Form1_Load(e1 As EventArgs, e2 As EventArgs)
        Me.Show()
    End Sub
    ...
    Public Sub Enemy2_Mover_Tick(sender As Object, e As EventArgs) Handles Enemy2_Mover.Tick
        EnemyCar2.Top += 2
    ...
    Public Sub Enemy3_Mover_Tick(sender As Object, e As EventArgs) Handles Enemy3_Mover.Tick
        EnemyCar3.Top += 5
    ...
    Public Sub Enemy4_Mover_Tick(sender As Object, e As EventArgs) Handles Enemy4_Mover.Tick
        EnemyCar4.Top += 4
